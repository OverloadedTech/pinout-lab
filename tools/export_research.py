...
def main():
    ...
    patterns = [
        ...
        "labs/common/native/*.cpp",
        "labs/common/native/*.hpp",
        "labs/common/java/**/*.java",
        "labs/common/assets/lab/Dobby-MODIFICATIONS.txt",
        "labs/pinout/native/*.cpp",
        "tools/*.py",
    ...
    archive = ROOT / "artifacts/pinout-lab-research-source.zip"
    archive.parent.mkdir(exist_ok=True)
    with zipfile.ZipFile(archive, "w", zipfile.ZIP_DEFLATED) as z:
        for name in sorted(manifest):
            z.write(target / name, "pinout-lab/" + name)
        z.write(target / "PUBLIC_EXPORT.json", "pinout-lab/PUBLIC_EXPORT.json")
    print(
        json.dumps(
            {
