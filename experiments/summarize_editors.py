...
def main():
    ...
    assert digest(ROOT/'artifacts/pinout-lab.apk')==build['sha256']==device['apk_sha256']
    assert digest(ROOT/'incoming/pinout/pinout.apk')==build['input_sha256']
    checks=[]
    ...
    with zipfile.ZipFile(ROOT/'artifacts/pinout-lab.apk') as apk,zipfile.ZipFile(ROOT/'incoming/pinout/pinout.apk') as original:
