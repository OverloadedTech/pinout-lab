...
> Shared Smash Hit reference. These save formats and service observations do not describe PinOut. See [game research](pinout.md).
...
In the earlier controlled experiment, Home/reopen retained position `(13,8,-230)`, 15 balls and an edited box in the same process. Force-stop/reopen created a new process, rebuilt the saved room at its entrance, restored the 25 balls on disk, and lost the runtime geometry edit. The automatic resume notes, which hold the score recalculation and complete evidence, are not part of this repository.
