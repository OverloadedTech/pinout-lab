...
This is the standalone PinOut Lab source export. Use the
[README](../README.md) for the APK hash, input path, toolchain setup, build
command and desktop entry point. The source release contains shared research
as well as the PinOut adapter; see [the documentation index](README.md).
