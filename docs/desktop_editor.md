...
> This is the Smash Hit segment editor. For PinOut use the [native scene editor](native_scene_editor.md) and the [root setup guide](../README.md).
...
The earlier bulk editor release is recorded in [editor_improvements.md](editor_improvements.md); current APK and desktop-to-game regression evidence is recorded in the Play/Edit notes, which are not part of this repository.
