...
The Granny Smith and PinOut addons use **Dobby**, Apache License 2.0, from
`https://github.com/jmpews/Dobby`, commit
`e9fe7fbecae47a2287e761080f8b1133cc22e8fa`. `tools/setup_hook.py` verifies
...
dependencies; its full LICENSE is included in each new Lab APK as
`assets/lab/Dobby-LICENSE.txt`.
